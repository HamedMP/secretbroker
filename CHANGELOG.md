...
All notable changes to SecretBroker are documented here. The project follows semantic versioning.
...
- Native Rust CLI with user, project, and session scopes.
- Secure masked terminal and one-time localhost browser collection.
- Another-terminal request, fulfillment, and wait workflow.
...
[0.1.0]: https://github.com/HamedMP/secretbroker/releases/tag/v0.1.0
